                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            @if(count($users)==0)
                                            <td colspan="7"><center>No User-Data!</center></td>
                                            @else
                                            ...
                                            <td>{{$user->address}}</td>																								
                                            <!-- <td>{{$user->date}}</td> -->
                                        <td><a href="/users/remove/{{$user->id}}" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
                                        <a href="/users/update/{{$user->id}}" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
                                    </td></tr>
                                            @endforeach
