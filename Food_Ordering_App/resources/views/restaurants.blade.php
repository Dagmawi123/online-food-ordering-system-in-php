...
<body>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item"> <a class="nav-link active" href="">Restaurants <span class="sr-only"></span></a> </li>
        ...
        <div class="page-wrapper">
            ...
            <div class="inner-page-hero bg-image" data-image-src="{{asset('images/img/res.jpeg')}} ">
                            ...
                            <div class="bg-gray restaurant-entry">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-8 text-xs-center text-sm-left">
															<div class="entry-logo">
																<a class="img-fluid" href="dishes.php?res_id=''" > <img src="{{asset('images/Res_img/5ad74b9dbc38a.jpg')}}" alt="Food logo"></a>
															</div>
															<!-- end:Logo -->
															<div class="entry-dscr">
																<h5><a href="dishes.php?res_id=''" >{{$restaurant->title}}</a></h5> <span>{{$restaurant->address}} <a href="#">...</a></span>
														 ...
														 <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
																<div class="right-content bg-white">
																	<div class="right-review">
																		...
																		<p> 245 Reviews</p> <a href="/orders/rest/{{$restaurant->id}}" class="btn theme-btn-dash">View Menu</a> </div>
																</div>
																<!-- end:right info -->
															</div>
