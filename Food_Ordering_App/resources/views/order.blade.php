...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="dishes.php?res_id='' ?>">Pick Your favorite food</a></li>
            ...
            <section class="inner-page-hero bg-image" data-image-src="{{asset('images/img/dish.jpeg')}}">
                <div class="profile">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12  col-md-4 col-lg-4 profile-img">
                                <div class="image-wrap">
                                    <figure><img src="{{ asset('images/Res_img/' . $restaurant->image) }}" alt="Restaurant logo"></figure>
                                </div>
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
                         ...
                         <div class="widget widget-cart">
                            ...
                            @foreach (session()->get('cart',[]) as $cartItem )
		                                       <div class="title-row">
										{{$cartItem['food']->title}}<a href="/cart/delete/{{$cartItem['food']->id}}" >
										<i class="fa fa-trash pull-right"></i></a>
										</div>
										
                                        <div class="form-group row no-gutter">
                                            <div class="col-xs-8">
                                                 <input type="text" class="form-control b-r-0" value='${{ $cartItem['food']->price }}' readonly id="exampleSelect1">
                                                   
                                            </div>
                                            <div class="col-xs-4">
                                               <input class="form-control" type="text" readonly value='{{ $cartItem['quantity']}}' id="example-number-input"> </div>
                                </div>
                                @endforeach
                                ...
                                <div class="widget-body">
                                    <div class="price-wrap text-xs-center">
                                        ...
                                        <p>Free Shipping</p>
                                        <a href="/orders/checkout"  class="btn theme-btn btn-lg">Checkout</a>
                                    </div>
                                </div>
                            ...
                            @foreach ($foods as $food)
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" >${{$food->price}}</span>
										  <input class="b-r-0" type="number"  name="quantity"  style="margin-left:30px; width:30px;" value="1" size="2" />
