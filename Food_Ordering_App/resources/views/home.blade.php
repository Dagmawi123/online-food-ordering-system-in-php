				...
				@foreach ( $foods as $food)
                 <div class="col-xs-12 col-sm-6 col-md-4 food-item">
														<div class="food-item-wrap">
															<div class="figure-wrap bg-image" data-image-src="images/Res_img/dishes/{{$food->image}}">
																<div class="distance"><i class="fa fa-pin"></i>1240m</div>
																<div class="rating pull-left"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div>
																<div class="review pull-right"><a href="#">198 reviews</a> </div>
															</div>
															<div class="content">
																<h5><a href="/orders/dish/{{$food->id}}">{{$food->title}}</a></h5>
																<div class="product-name">{{$food->slogan}}</div>
																<div class="price-btn-block"> <span class="price">${{$food->price}}</span> <a href="/orders/dish/{{$food->id}}" class="btn theme-btn-dash pull-right">Order Now</a> </div>
															</div>
            ...
            <div class="container">
                        ...
                        <div class="restaurants-filter pull-right">
                            <nav class="primary pull-left">
                                <ul>
 								...
 								<li><a href="#" data-filter=".{{$cat->CategoryName}}"> {{$cat->CategoryName}}</a> </li>                       
                                   @endforeach                                 
                ...
                <div class="row">
                    ...
                    @foreach ($restaurants as $rest )
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-6 single-restaurant all {{$rest->category->CategoryName}} ">
                    <div class="restaurant-wrap">
                        <div class="row">
                            <div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
                                <a class="restaurant-logo" href="/orders/rest/{{$rest->id}}" > <img src="images/Res_img/5ad74b9dbc38a.jpg" alt="Restaurant logo"> </a>
                            </div>
                            <!--end:col -->
                            <div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
                                <h5><a href="/orders/rest/{{$rest->id}}" >{{$rest->title}}</a></h5> <span>{{$rest->address}}</span>
